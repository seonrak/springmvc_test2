...
<label for = "id" class="form-label">아이디</label><input type="text" class="form-control" id="id" maxlength="20" minlength="4"
 placeholder="영문(대소문자),숫자,특수문자(4~16조합)"></div>
 	</div>
 </div>
 <div class = "container-fluid">
  <div class = "row">
  <div class = "col-12 col-md-6">
  	...
  	placeholder="영문(대소문자),숫자,특수문자(4~16조합)">
  		</div>
  		<div class = "col-12 col-md-6">
 ...
 <div class = "container-fluid">
  <div class = "row">
  <div class = "col-12 col-md-6">
  	<label for ="name" class = "form-label">이름</label><input type="text" class = "form-control" id="name" maxlength="20" minlength ="4">
  		</div>
  		<div class = "col-12 col-md-6">
  	<label for ="nameeg" class = "form-label">이름(영문)</label><input type="text" class = "form-control" id="nameeg" maxlength="20" minlength ="4">
  		</div>
  	</div>
  </div>
 ...
 <div class = "container-fluid">
  ...
  <div class = "col-12 col-md-6">
  	<label for ="name" class = "form-label">이름</label><input type="text" class = "form-control" id="name" maxlength="20" minlength ="4">
  		...
  		<div class = "col-12 col-md-6">
  	<label for ="nameeg" class = "form-label">성</label><input type="text" class = "form-control" id="nameeg" maxlength="20" minlength ="4">
  		</div>
  	</div>
  </div>
  ...
  <div class = "row">
  <div class = "col-12 col-md-6">
  	<label for ="password" class = "form-label">핸드폰</label><input type="text" class = "form-control" id="password" maxlength="20" minlength ="4" placeholder="010-0000-0000">
  		</div>
  		<div class = "col-12 col-md-6">
 ...
 <div class = "container-fluid">
  <div class = "row">
  <div class = "col-12 col-md-6">
  	<label for ="number" class = "form-label">전화번호</label><input type="text" class = "form-control" id="number">
  		</div>
  		<div class = "col-12 col-md-6">
  	<label for ="fax" class = "form-label">팩스번호</label><input type="text" class = "form-control" id="fax">
  		</div>
  	</div>
  </div>
